...
public class TesteStreamsParalelos {
    ...
    public static void main(String[] args) {
        ...
        List.of(1).stream().limit(1).parallel().distinct();
        ...
        // tirar proveito nucleos, para ganhar perfomance
        // separar o processo em varias threads
        
        // forEach
        List<Integer> numeros = List.of(1, 2, 3, 4);
        numeros.stream().forEach(System.out::println); // unica thread

        System.out.println("------------------------");

        numeros.parallelStream().forEach(System.out::println); // paralela - varias thread
        System.out.println("------------------------");
        numeros.parallelStream().forEachOrdered(System.out::println); // paralelismo e precisar respeitar o ordem , pode usar o forEachOrdered
